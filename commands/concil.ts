...
export async function execute(client: Client, message: Message, args: string[], db: PgClient) {
    ...
    if (!mentioned) {
        return message.channel.send(new Attachment('https://media.discordapp.net/attachments/664235191065247775/677146760807710730/image0.png?width=1069&height=582', 'council.jpg'))
    }
    message.delete()
